...
$lang['AdminDomains.configuration.field_override_price'] = 'Set TLD pricing as override price';
...
$lang['AdminDomains.configuration.tooltip_override_price'] = 'When enabled, the package will record the package pricing as the override price when the service is added. This allows to make changes to the package pricing without affecting existing services.';
